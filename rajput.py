...
TOKEN = '7978137554:AAEp6xTUa8IpyUR0AwZZv8cD1XmGNDbKMYE'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -7319534302
CHANNEL_ID = -7319534302
error_channel_id = -7319534302
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/+Aq1D4g7QD2BmMmVl*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*https://t.me/+Aq1D4g7QD2BmMmVl*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*@RAJPUTMODDER*", parse_mode='Markdown')
    else:
